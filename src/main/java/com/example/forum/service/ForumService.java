...
public class ForumService {
    ...
    private void init() {
        ...
        this.cat1 = new Category("Học hành");
        ...
        Topic topic2 = new Topic(2, "Thủ tướng: Trường ĐH tự quyết mức học phí",
                "ọc phí mầm non và phổ thông ở trường công lập là sự đóng góp một phần nhỏ "
                        ...
                        + "phí đào tạo",
                users.get("leb"), cat1);
        topic2.addMessage(new Message("Re: Xung quanh dự thảo của Đề án tăng học phí",
    ...
    public Integer getLastTopicIdx(){
       return this.topics.get(this.topics.size()).getId();
    }
    ...
    public void addTopic(Topic newTopic){
        this.topics.put(this.getLastKey() + 1, newTopic);
    }
